...
class PositionalEncoding(nn.Module):
    ...
    def __init__(self, d_model: int, dropout: float = 0.1, max_len: int = 2000, max_year: int = 5000):
        super().__init__()
...
class EHRModel(pl.LightningModule):
    def __init__(self, model_name, input_dim, num_feat=128, num_heads=4,
                 ...
                 use_cpcc=False, cpcc_lamb=1.0, cpcc_distance_type='l2', cpcc_center=False,
                 hparams = None):
